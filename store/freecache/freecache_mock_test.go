...
func (mr *MockFreecacheClientInterfaceMockRecorder) Del(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFreecacheClientInterfaceMockRecorder) DelInt(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFreecacheClientInterfaceMockRecorder) Get(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFreecacheClientInterfaceMockRecorder) GetInt(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFreecacheClientInterfaceMockRecorder) Set(key, value, expireSeconds any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFreecacheClientInterfaceMockRecorder) SetInt(key, value, expireSeconds any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFreecacheClientInterfaceMockRecorder) TTL(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
