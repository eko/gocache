...
func (mr *MockHazelcastMapInterfaceMockRecorder) Clear(ctx any) *gomock.Call {
...
func (mr *MockHazelcastMapInterfaceMockRecorder) Get(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockHazelcastMapInterfaceMockRecorder) GetEntryView(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockHazelcastMapInterfaceMockRecorder) SetWithTTL(ctx, key, value, ttl any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
