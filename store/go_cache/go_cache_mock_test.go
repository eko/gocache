...
func (m *MockGoCacheClientInterface) Add(k string, x any, d time.Duration) error {
	m.ctrl.T.Helper()
...
func (mr *MockGoCacheClientInterfaceMockRecorder) Add(k, x, d any) *gomock.Call {
...
func (mr *MockGoCacheClientInterfaceMockRecorder) Delete(k any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGoCacheClientInterfaceMockRecorder) Get(k any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGoCacheClientInterfaceMockRecorder) GetWithExpiration(k any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGoCacheClientInterfaceMockRecorder) Set(k, x, d any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
