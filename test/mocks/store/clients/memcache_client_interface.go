...
// MemcacheClientInterface is an autogenerated mock type for the MemcacheClientInterface type
type MemcacheClientInterface struct {
	mock.Mock
}

// Delete provides a mock function with given fields: item
func (_m *MemcacheClientInterface) Delete(item string) error {
	ret := _m.Called(item)
...
func (_m *MemcacheClientInterface) Set(item *memcache.Item) error {
	ret := _m.Called(item)
