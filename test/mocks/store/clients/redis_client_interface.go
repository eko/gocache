...
func (_m *RedisClientInterface) Del(keys ...string) *redis.IntCmd {
...
func (_m *RedisClientInterface) Set(key string, value interface{}, expiration time.Duration) *redis.StatusCmd {
