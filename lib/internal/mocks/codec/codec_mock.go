...
func (mr *MockCodecInterfaceMockRecorder) Clear(ctx any) *gomock.Call {
...
func (mr *MockCodecInterfaceMockRecorder) Delete(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCodecInterfaceMockRecorder) Get(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCodecInterfaceMockRecorder) GetWithTTL(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCodecInterfaceMockRecorder) Invalidate(ctx any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCodecInterfaceMockRecorder) Set(ctx, key, value any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
